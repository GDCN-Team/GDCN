<template>
    <page-layout class="lg:w-1/3" title="关卡搬出">
        <n-card>
            <n-form :model="form">
                <n-form-item
                    required
                    ...
                    path="form.server"
                    label="服务器">
                    <n-select @update:value="reloadLinkAccounts" v-model:value="form.server" :options="serverOptions"
                              placeholder="服务器"></n-select>
                </n-form-item>
                ...
                <n-collapse>
                    <n-collapse-item title="关卡设置" name="setting">
                        ...
                        <n-form-item
                            ...
                            <n-input v-else type="number" v-model:value="form.level_song_id"
                                     placeholder="关卡歌曲ID"></n-input>
                        </n-form-item>
                        <n-form-item
                            :validation-status="form.errors.level_password ? 'error' : null"
                            :feedback="form.errors.level_password ?? null"
                            path="form.level_password"
                            label="关卡密码">
                            <n-input type="number" v-model:value="form.level_password"
                                     placeholder="关卡密码(留空不变)"></n-input>
...
export default {
    ...
    setup: function (props) {
        ...
        const levelAudioTracks = [
            {label: "Practice: Stay Inside Me - OcularNebula", value: -1},
            {label: "Stereo Madness - Foreverbound", value: 0},
            {label: "Back on Track - DJVI", value: 1},
            {label: "Polargeist - Step", value: 2},
            {label: "Dry Out - DJVI", value: 3},
            {label: "Base after Base - DJVI", value: 4},
            {label: "Cant Let Go - DJVI", value: 5},
            {label: "Jumper - Waterflame", value: 6},
            {label: "Time Machine - Waterflame", value: 7},
            {label: "Cycles - DJVI", value: 8},
            {label: "xStep - DJVI", value: 9},
            {label: "Clutterfunk - Waterflame", value: 10},
            {label: "Theory of Everything - DJ-Nate", value: 11},
            {label: "Electroman Adventures - Waterflame", value: 12},
            {label: "Clubstep - DJ-Nate", value: 13},
            {label: "Electrodynamix - DJ-Nate", value: 14},
            {label: "Hexagon Force - Waterflame", value: 15},
            {label: "Blast Processing - Waterflame", value: 16},
            {label: "Theory of Everything 2 - DJ-Nate", value: 17},
            {label: "Geometrical Dominator - Waterflame", value: 18},
            {label: "Deadlocked - F-777", value: 19},
            {label: "Fingerdash - MDK", value: 20},
            {label: "The Seven Seas - F-777", value: 21},
            {label: "Viking Arena - F-777", value: 22},
            {label: "Airborne Robots - F-777", value: 23},
            {label: "The Challenge - RobTop", value: 24},
            {label: "Payload Dex - Arson", value: 25},
            {label: "Beast Mode - Dex Arson", value: 26},
            {label: "Machina - Dex Arson", value: 27},
            {label: "Years - Dex Arson", value: 28},
            {label: "Frontlines - Dex Arson", value: 29},
            {label: "Space Pirates - Waterflame", value: 30},
            {label: "Striker - Waterflame", value: 31},
            {label: "Embers - Dex Arson", value: 32},
            {label: "Round 1 - Dex Arson", value: 33},
            {label: "Monster Dance Off - F-777", value: 34},
            {label: "Press Start - MDK", value: 35},
            {label: "Nock Em - Bossfight", value: 36},
            {label: "Power Trip - Boom Kitty", value: 37}
        ];
