...
/**
 * Class GameChallengesController
 * @package App\Http\Controllers
 */
class GameChallengesController extends Controller
{
    /**
     * @var string[]
     */
     ...
     */
    public function get(GameChallengeGetRequest $request, GameHashesController $hash)
    {
        try {
