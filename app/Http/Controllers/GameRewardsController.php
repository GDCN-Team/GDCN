 ...
 */
class GameRewardsController extends Controller
{
    /**
     ...
     */
    public function get(GameRewardGetRequest $request, GameHashesController $hash)
    {
        try {
            ...
            switch ($data['rewardType']) {
                case GameRewardType::GET:
                    break;
                case GameRewardType::OPEN_SMALL:
