...
/**
 * Class GameUserScoresController
 * @package App\Http\Controllers
 */
class GameUserScoresController extends Controller
{
    /**
     ...
     */
    public function update(GameUserScoreUpdateRequest $request, GameHashesController $hash)
    {
