...
use App\Http\Controllers\Game\Level\ScoresController as LevelScoreController;
...
use App\Http\Controllers\Game\UserScoresController as UserScoreController;
...
Route::group(['domain' => 'gf.geometrydashchinese.com', 'as' => 'game.'], function () {
    ...
    Route::post('/getGJAccountComments20.php', [AccountCommentController::class, 'get'])->name('account.comment.list');
    Route::post('/uploadGJAccComment20.php', [AccountCommentController::class, 'upload'])->name('account.comment.upload');
    ...
    Route::post('/getGJComments21.php', [LevelCommentController::class, 'get'])->name('level.comment.get');
    Route::post('/uploadGJComment21.php', [LevelCommentController::class, 'upload'])->name('level.comment.upload');
    ...
    Route::post('/getGJScores20.php', [UserScoreController::class, 'get'])->name('score.get');
    Route::post('/getGJLevelScores211.php', [LevelScoreController::class, 'get'])->name('level.score.get');
    Route::post('/getGJCommentHistory.php', [LevelCommentController::class, 'history'])->name('level.comment.history');
